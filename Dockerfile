...
WORKDIR /app
ARG proxy="http://child-prc.intel.com:913"
ENV http_proxy=$proxy https_proxy=$proxy
RUN echo 'Acquire::http::proxy "http://child-prc.intel.com:913";' >> /etc/apt/apt.conf && echo 'Acquire::https::proxy "http://child-prc.intel.com:913";' >> /etc/apt/apt.conf
